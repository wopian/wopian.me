...
(function() {
    ...
    Nb.prototype = {
        ...
        refresh: function(a, b) {
            ...
            i = i.call(h, this);
            h = a.series;
            this.assetsance = p(h.tooltipOptions.assetsance, 16);
            ...
            if (d && this.options.tooltip.shared && (!h || !h.noSharedTooltip)) {
                ...
                for (j = 0; j < i; j++)
                    if (c[j].visible && c[j].options.enableMouseTracking !== !1 && !c[j].noSharedTooltip &&
                        c[j].singularTooltips !== !0 && c[j].tooltipPoints.length && (e = c[j].tooltipPoints[l]) && e.series) e._assets = Q(l - e.clientX), k = L(k, e._assets), f.push(e);
                for (i = f.length; i--;) f[i]._assets > k && f.splice(i, 1);
